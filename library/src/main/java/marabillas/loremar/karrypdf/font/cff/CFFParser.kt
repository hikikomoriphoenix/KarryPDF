package marabillas.loremar.karrypdf.font.cff

import androidx.collection.SparseArrayCompat
import marabillas.loremar.karrypdf.exceptions.font.InvalidCFFException
...
internal class CFFParser(private val data: ByteArray, private val fontName: String) {
    ...
    private fun processNameIndex(): Int {
        ...
        if (fontNames.count() == 1) {
            ...
            throw InvalidCFFException(
                "Can't determine which font to use"
            )
        }
    }
