...
class ASCII85Test {
    ...
    fun testDecode() {
        ...
        assertThat(String(bytes, Charsets.US_ASCII), `is`("Hello World"))
        ...
        assertThat(String(bytes, Charsets.US_ASCII), `is`("The quick brown fox jumps over the lazy dog. 0123456789"))
        println(
