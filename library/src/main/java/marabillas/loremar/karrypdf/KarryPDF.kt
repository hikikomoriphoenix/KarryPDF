...
import marabillas.loremar.karrypdf.contents.ContentStreamParser
...
import marabillas.loremar.karrypdf.font.FontDecoder
import marabillas.loremar.karrypdf.font.FontMappings
import marabillas.loremar.karrypdf.font.FontName
import marabillas.loremar.karrypdf.objects.*
import marabillas.loremar.karrypdf.utils.*
import java.io.RandomAccessFile

class KarryPDF(file: RandomAccessFile, password: String = "") {
    ...
    fun getPageContents(pageNum: Int): List<PageContent> {
        ...
        val contents = pageDic["Contents"] ?: throw InvalidDocumentException(
    ...
    private fun parseContent(
        ...
        try {
            ...
            stream?.let {
                ...
                TimeCounter.reset()
                val pageObjs = ContentStreamParser(
                    context
                ).parse(String(data), ref.obj, ref.gen)
    ...
    private fun getPageResourcesFromAncestors(pageDic: Dictionary): Dictionary {
        ...
        if (parent is Dictionary) {
            ...
            throw InvalidDocumentException(
                "Page dictionary is missing a Resources Entry"
            )
        }
    }
