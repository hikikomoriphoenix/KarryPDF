...
import marabillas.loremar.karrypdf.contents.text.*
...
/*    @Test
    ...
    fun testCheckForListTypeTextGroups() {
        val t0 =
            TextElement(tj = "(A)".toPDFString())
        val t1 =
            TextElement(tj = "(Dog.)".toPDFString())
        val t2 =
            TextElement(tj = "(cat.)".toPDFString())
        val t3 =
            TextElement(tj = "(Rat.)".toPDFString())
        val g1 = TextGroup()
        g1.add(arrayListOf(t0, t1))
        g1.add(arrayListOf(t2))
        g1.add(arrayListOf(t3))
        val t4 =
            TextElement(tj = "(Hi my name is)".toPDFString())
        val t5 =
            TextElement(tj = "(James Bond.)".toPDFString())
        val g2 = TextGroup()
        ...
        val t6 =
            TextElement(tj = "(A)".toPDFString())
        val t7 =
            TextElement(tj = "(Car.)".toPDFString())
        val t8 =
            TextElement(tj = "(Plane.)".toPDFString())
        val t9 =
            TextElement(tj = "(Boat.)".toPDFString())
        val g3 = TextGroup()
        g3.add(arrayListOf(t6, t7))
        g3.add(arrayListOf(t8))
        g3.add(arrayListOf(t9))
        val t10 =
            TextElement(tj = "(Asta la vista)".toPDFString())
        val t11 =
            TextElement(tj = "(Baby.)".toPDFString())
        val g4 = TextGroup()
    ...
    fun testGetLargestWidth() {
        val t1 =
            TextElement(tj = "(Hello)".toPDFString())
        val t2 =
            TextElement(tj = "(World)".toPDFString())
        val t3 =
            TextElement(tj = "(Hi)".toPDFString())
        val g1 = TextGroup()
        val g2 = TextGroup()
